...
const JORDAN: DemoMealSeed[] = [
  m(20, 8, "Breakfast", "Oatmeal with a banana and a splash of milk.", {
    ...
    micronutrients: [{ nutrient: "calcium", level: "present", from: "Milk" }],
  ...
  m(19, 13, "Lunch", "Spinach salad with chickpeas and a light dressing, coffee after.", {
    ...
    micronutrients: [
      ...
      { nutrient: "magnesium", level: "present", from: "Spinach" },
    ],
  ...
  m(18, 19, "Dinner", "Grilled chicken with rice and steamed broccoli.", {
    ...
    micronutrients: [{ nutrient: "choline", level: "present", from: "Chicken breast" }],
  ...
  m(17, 8, "Breakfast", "Two eggs and toast.", {
    ...
    micronutrients: [
      { nutrient: "b12", level: "present", from: "Eggs" },
      { nutrient: "choline", level: "strong", from: "Eggs" },
    ],
  ...
  m(15, 13, "Lunch", "Lentil soup with a slice of bread, tea on the side.", {
    ...
    micronutrients: [{ nutrient: "iron", level: "light", from: "Lentils" }],
  ...
  m(14, 19, "Dinner", "Beef stir fry with peppers and rice.", {
    ...
    micronutrients: [{ nutrient: "iron", level: "strong", from: "Beef" }],
  ...
  m(11, 8, "Breakfast", "Yogurt with berries and a few pumpkin seeds.", {
    ...
    micronutrients: [
      { nutrient: "calcium", level: "present", from: "Yogurt" },
      { nutrient: "iron", level: "present", from: "Pumpkin seeds" },
      { nutrient: "magnesium", level: "present", from: "Pumpkin seeds" },
    ],
  ...
  m(9, 13, "Lunch", "Spinach salad with chickpeas, lemon dressing this time.", {
    ...
    micronutrients: [{ nutrient: "iron", level: "present", from: "Spinach" }],
  ...
  m(6, 19, "Dinner", "Tofu and broccoli stir fry with a squeeze of lime.", {
    ...
    micronutrients: [{ nutrient: "iron", level: "present", from: "Tofu" }],
  ...
  m(3, 8, "Breakfast", "Oatmeal with pumpkin seeds and orange slices.", {
    ...
    micronutrients: [
      { nutrient: "iron", level: "strong", from: "Pumpkin seeds" },
      { nutrient: "magnesium", level: "present", from: "Pumpkin seeds" },
    ],
  ...
  m(1, 13, "Lunch", "Lentil and beet salad with orange segments.", {
    ...
    micronutrients: [{ nutrient: "iron", level: "strong", from: "Lentils" }],
  ...
  m(0, 8, "Breakfast", "Yogurt with pumpkin seeds and orange slices.", {
    ...
    micronutrients: [{ nutrient: "iron", level: "strong", from: "Pumpkin seeds" }],
...
const MORGAN: DemoMealSeed[] = [
  ...
  m(18, 13, "Lunch", "Chicken sandwich with lettuce.", {
    ...
    micronutrients: [{ nutrient: "choline", level: "present", from: "Chicken" }],
  ...
  m(14, 8, "Breakfast", "Toast with peanut butter and banana.", {
    ...
    micronutrients: [{ nutrient: "magnesium", level: "present", from: "Peanut butter" }],
  ...
  m(12, 13, "Lunch", "Chicken sandwich with lettuce, tomato, and avocado.", {
    ...
    micronutrients: [{ nutrient: "magnesium", level: "present", from: "Avocado" }],
  ...
  m(5, 13, "Lunch", "Big bowl with quinoa, chickpeas, cucumber, tomato, peppers, and feta.", {
    ...
    micronutrients: [{ nutrient: "calcium", level: "present", from: "Feta" }],
...
const SAM: DemoMealSeed[] = [
  m(18, 8, "Breakfast", "Chia pudding with almond milk and blueberries.", {
    ...
    micronutrients: [{ nutrient: "omega_3", level: "strong", from: "Chia seeds" }],
  ...
  m(14, 19, "Dinner", "Grilled tofu with quinoa and roasted vegetables.", {
    ...
    micronutrients: [{ nutrient: "magnesium", level: "present", from: "Quinoa" }],
  ...
  m(11, 8, "Breakfast", "Eggs with avocado on sourdough.", {
    ...
    micronutrients: [{ nutrient: "choline", level: "strong", from: "Eggs" }],
    offered: ["Great choline source"],
    worth_trying: [],
    absorption_notes: [],
  ...
  m(9, 13, "Lunch", "Sardine and white bean salad with lemon.", {
    ...
    micronutrients: [
      { nutrient: "omega_3", level: "strong", from: "Sardines" },
      { nutrient: "calcium", level: "present", from: "Sardines" },
      { nutrient: "vitamin_d", level: "present", from: "Sardines" },
    ],
  ...
  m(6, 19, "Dinner", "Baked cod with lentils and roasted brussels sprouts.", {
    ...
    micronutrients: [{ nutrient: "iodine", level: "present", from: "Cod" }],
  ...
  m(3, 8, "Breakfast", "Flaxseed oatmeal with walnuts and berries.", {
    ...
    micronutrients: [{ nutrient: "omega_3", level: "strong", from: "Ground flaxseed" }],
